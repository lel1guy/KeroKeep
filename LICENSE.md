...
> Required Notice: Copyright 2025 lel1guy (https://github.com/lel1guy)
...
Competes means the purpose provides a product that is a substitute for the
software or any other product provided by the licensor or any of its
affiliates. For clarity, a product that competes includes any product that:

1.  **Redistributes** the software or any part of it (including modified or
    extended versions) as a game, application, or interactive experience that
    can be played by end users without payment to the licensor;

2.  **Sells, licenses, or monetizes** the software or any derivative work based
    on it through any distribution platform (including but not limited to
    Steam, itch.io, Epic Games Store, Google Play, App Store, or any website);

3.  **Offers the software as a service** (SaaS) or otherwise makes the
    software's functionality available to third parties for a fee;

4.  **Includes the software as part of a larger product** that is sold or
    monetized, unless the licensor grants a separate commercial license.

### No Harm to Monetization

You may not use the software or any substantial portion of it to create a
competing game — even if you change the name, art, audio, or branding — without
a separate commercial license from the licensor. The code is source-available
for learning, portfolio review, and contribution, not for free commercial
exploitation.
...
The first time you are notified that you have violated any of these terms, or
done anything with the software not covered by your licenses, your licenses can
nonetheless continue if you come into full compliance with these terms, and
